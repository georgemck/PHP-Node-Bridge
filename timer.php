...
// $filePath = "~/www/example.com/public_html/dev/";
$output = -1;
$error = -1;

exec("export PATH=$PATH:~/www/nodejs/bin && node ~/www/example.com/public_html/dev/index.js " . $_REQUEST['text'] . " one two=three four 2>&1", $output, $error);
